...
;(function($) {
  ...
  var global_rotate_degrees = 0;
  var rotateTestimonial = function(){
  	$('.testimonial-arrow-left').on('click',function(){
  		global_rotate_degrees -=90;
  		$('#cube').css('transform','rotateY('+global_rotate_degrees+'deg)');	
  	})
  ...
  var initialTransformations = function(){
  	$(window).scroll(function(){
  		if($('.home-section-columns-left').isOnScreen() && columns_played === false){
  			...
  			//$('.home-section-columns')[0].style.webkitAnimationPlayState = "start";
  		}
