        ...
        <div class="slides-container">
            <?php 
                if ( get_theme_mod('slider_image_1', get_template_directory_uri() . '/images/1.png') ) {
                    echo '<div>';
                    echo '<div class="slide-item" style="-webkit-filter:blur(2px);width:100%;height:100%;background-image:url(' . esc_url(get_theme_mod('slider_image_1', get_template_directory_uri() . '/images/1.jpg')) . ');"></div>';
                    ?>
                        <div style="background-color:rgba(8,104,189,0.45);width:100%;height:100%"></div>  
